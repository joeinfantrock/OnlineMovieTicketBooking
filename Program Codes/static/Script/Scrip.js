...
function cowseat() { 
    ...
    document.getElementById("rownames").value = selected_seat.options[selected_seat.selectedIndex].text;  
    document.getElementById("rownos").value = selected_seatno.options[selected_seatno.selectedIndex].text; 

    if (cow == '2') { 
        var selected_seat = document.getElementById("row2") 
        var selected_seatno = document.getElementById("seat2no") 
        document.getElementById("rownames2").value = selected_seat.options[selected_seat.selectedIndex].text;  
        document.getElementById("rownos2").value = selected_seatno.options[selected_seatno.selectedIndex].text; 
    } 
    ...
    if (cow == '3') { 
        ...
        document.getElementById("rownames3").value = selected_seat.options[selected_seat.selectedIndex].text;  
        document.getElementById("rownos3").value = selected_seatno.options[selected_seatno.selectedIndex].text; 
    } 
    ...
    if (cow == '4') { 
        ...
        document.getElementById("rownames4").value = selected_seat.options[selected_seat.selectedIndex].text;  
        document.getElementById("rownos4").value = selected_seatno.options[selected_seatno.selectedIndex].text; 
    } 
    ...
    if (cow == '5') { 
        ...
        document.getElementById("rownames5").value = selected_seat.options[selected_seat.selectedIndex].text;  
        document.getElementById("rownos5").value = selected_seatno.options[selected_seatno.selectedIndex].text; 
    } 
}   
